...
load(file="PCA500_patience2_dropout20_2layerx100_layeradd/individualresult10000.Rdata")
...
quantpredicted50 <- quantile(predictedpayoffallscen,0.50)
scentop50 <- which(predictedpayoffallscen>=quantpredicted50)


traindata_NN <- traindata_NN_original[traindata_NN_original$Scenario %in% scentop50,]
testdata_NN <- testdata_NN_original[testdata_NN_original$Scenario %in% scentop50,]
...
setwd("/srv/scratch/z5238225/VariableAnnuitiesparallel")
save(scentop50,traindata_NN,testdata_NN,scenario_pca,FMVallpol,payoffallscen, alldata_NN, scendata, trainx,trainy,
     testx,testy,allpol,allscensize,numvar,file="scentop50_PCA500_patience2_dropout20_2layerx100_layeradd/finaldata.Rdata")
